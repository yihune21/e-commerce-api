...
func main()  {
	...
	v1Router.Post("/login",apiCfg.Login)
    ...
    v1Router.Post("/product",apiCfg.middlewareAuth(apiCfg.GetProductByName))
	v1Router.Get("/products",apiCfg.GetAllProducts)
	v1Router.Patch("/admin/product-price/{id}",apiCfg.AdminMiddlewareAuth(apiCfg.UpdateProductPrice))
	v1Router.Patch("/admin/product-image/{id}",apiCfg.AdminMiddlewareAuth(apiCfg.UpdateProductImage))
    ...
    v1Router.Patch("/admin/order/cancel/{id}" ,apiCfg.AdminMiddlewareAuth(apiCfg.OrderCancellation))
